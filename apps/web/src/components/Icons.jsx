...
export const PlayIcon = ({ size = 24, color }) => (
  <svg viewBox="0 0 24 24" fill={color || "currentColor"} width={size} height={size}>
...
export const MaximizeIcon = ({ size = 24 }) => (
...
export const VolumeMuteIcon = ({ size = 24 }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width={size} height={size}>
    <polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5" />
...
export const StrawHatIcon = ({ size = 24, color }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke={color || "currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width={size} height={size}>
