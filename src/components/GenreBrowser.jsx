...
/**
 * GenreBrowser — Netflix-style "browse by genre" row.
 * Fetches the movie+TV genre lists once, merges by name, and on selection
 * pulls a popularity-sorted discover() result for that genre into a Bento grid.
 */
